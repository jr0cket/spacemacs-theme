...
(defun create-spacemacs-theme (variant theme-name)
  (dyn-let ((class '((class color) (min-colors 89))) ;;              ~~ Dark ~~                              ~~ Light ~~
        ...
        (base-dim      (if (eq variant 'dark) (if (true-color-p) "#545557" "#585858") (if (true-color-p) "#a094a2" "#afafd7")))
        ...
        (comment       (if (eq variant 'dark) (if (true-color-p) "#7e7e7e" "#008787") (if (true-color-p) "#2aa1ae" "#008787")))
        (comment-bg    (if (eq variant 'dark) (if (true-color-p) "#000000" "#262626") (if (true-color-p) "#ecf3ec" "#ffffff")))
...
;;;;; basics
     ...
     `(font-lock-comment-face ((,class (:foreground ,comment :italic t :background ,(when spacemacs-theme-comment-bg comment-bg)))))
